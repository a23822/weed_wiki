                                ...
                                <div className={styles.detail_inner}>
                                    ...
                                    <div className={styles.title_area}>
                                        ...
                                        <div className={styles.tag_group}>
                                            <button type="button" onClick={onClickLabelInfoBtn} className={`${styles.btn_label} type_${info_detail.rank.toLowerCase()}`} aria-pressed={isPressedLabelInfoBtn}>{info_detail.rank}<RiInformationLine className={styles.ico_info} aria-label="관련 정보 보기"/></button>
